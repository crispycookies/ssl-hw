...
SOURCEFILES := Actuator.cpp APDS9301.cpp HDC1000.cpp main.cpp MPU9250.cpp MQTTPackager.cpp MQTTPublisher.cpp Sensor.cpp SevenSegDisplay.cpp
EXTERNAL_LIBS := 
